...
$(function(){
	...
	function fillPlanInfo(){
		if(plan.timeType == 1){
			$("timeValue1").val(plan.timeValue);
		}else{
			$("timeValue2").val(plan.timeValue);
		}
		$.each($("input[name='trainType']"),function(index,val){
			$.each(plan.trainType.split(','),function(index_, val_){
				if($(val).val() == val_){
					val.checked = true;
				}
			})
		...
		$('#addForm').isValid(function(v) {
			if(v){
				...
				$.ajax({
			   		...
			   		data:param(),
			   		url:"<%=request.getContextPath()%>/train/updateTrainPlan.action",
	...
	function param(){
		...
		o.name=$("#name").val();
		o.period=$("#period").val();
		o.timeType = plan.timeType;
		plan.timeType == 1 ? (o.timeValue = $("#timeValue1").val()):(o.timeValue = $("#timeValue2").val());
...
<div id="content" class="content">
	...
	<div style="padding-bottom: 5px;border-bottom: 1px solid #cccccc; margin-bottom: 10px;">
		...
		<span id="title_span" style="  position: relative;top: 5px; color: #3a3a3a; font-size: 16px; font-weight: bold;">修改计划</span>
	</div>
   		<form id="addForm">
            <div class="lesson_add">
		        ...
		        <div class="add_gr">
		            ...
		            <div class="add_fr">
		            <input type="text" class="i_name" id="name" name="name" value="${plan.name }"/>
		            </div>
		        </div>
		        <div class="add_gr">
		        	<div class="add_fl">
		            ...
		            <div class="add_fr">
		            	<input type="text" class="i_name" id="period" name="period" value="${plan.period }"/>
		            </div>
		        </div>
		        <div class="add_gr">
		        	<div class="add_fl">
		            ...
		            <div class="add_fr">
		            	<input type="checkbox" checked name="trainType" value="1"/>
		                <span>在线培训</span>
		         ...
		         <div class="add_gr">
		            ...
		            <div class="add_fr">
		            	<input type="text" class="i_name" id="teacherName" name="teacherName" value="${plan.teacherName }"/>
		            </div>
		        </div>
		         <div class="add_gr">
		        	<div class="add_fl">
		            ...
		            <div class="add_fr">
		            	<input type="text" class="i_name" id="agency" name="agency" value="${plan.agency }"/>
		            </div>
		        </div>
		         <div class="add_gr">
		        	<div class="add_fl">
		            ...
		            <div class="add_fr">
		            	<input type="text" id="target" name="target" value="${plan.target }"/>
		            </div>
		        </div>
		        <div class="add_gr">
		        	<div class="add_fl">
		            ...
		            <div class="add_fr">
		            	...
		            	<textarea id="descr" name="descr">${plan.descr }</textarea>
		            </div>
		        </div>
	             <div class="button_cz">
