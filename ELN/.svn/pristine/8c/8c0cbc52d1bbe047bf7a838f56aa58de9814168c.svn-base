...
function selectCategory(){
	var categoryId = ${klJSON.categoryId}||0;
	//打开设置框
	 dialog({
	...
	<form action="" id="knowledgeForm">
		<ul class='kl-list'>
			...
			<%-- <li class='margin-left: -22px;'><div class='kl-label'>
				...
				<li class="add_gr" style='height: 650px;'>
		        	<div class='kl-label'>
					<span
						style="font-family: 'Applied Font Regular', 'Applied Font'; color: #FF0000;">*</span>知识内容:
					</div>
		             <div class="add_fr" style="width: 720px;height: 650px;margin-left: 90px;position: relative;">
