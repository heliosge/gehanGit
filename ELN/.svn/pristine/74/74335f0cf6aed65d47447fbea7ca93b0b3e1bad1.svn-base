...
function save(saveFlag){
	$('#addForm').isValid(function(v) {
		...
		if(!v){
			...
			if(saveFlag == 2 || examState == 'PUBLISHED'){
				if(tempList ==''){
					dialog.alert("请添加人员！");
					return false;
				}
...
<!-- dialog1 选择试卷 start -->
	<div id="selectPaper" style="display: none;">
		<div class="course_tree treeDiv1">
        	<div id="paperTree" class="ztree treeDiv2" style=""></div>
   		</div>
	...
	<!-- <div class="course_tree" style="display:none;" id="groupDiv">
  	...
  	<div id="selectPerson" style="display: none;">
		<div class="course_tree treeDiv1" style="max-height:440px;height:440px;width:200px;overflow:auto;border:1px solid #DDD;" >
        	<ul id="personTree" class="ztree treeDiv2" style="max-height:440px;height:440px;width:200px;overflow:auto;border:1px solid #DDD;" ></ul>
   		</div>
