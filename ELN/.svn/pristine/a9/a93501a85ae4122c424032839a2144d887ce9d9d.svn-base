...
function chooseUser(){
	artDialog = dialog({
		url:"<%=request.getContextPath()%>/certificate/chooseMultiStu.action",
        title:"选择人员" ,
        lock:true,
        height: 500,
		width: 1100
...
function save(){
	...
	if(v){
		var paramData = param();
		if(paramData.receiveUserIds.length == 0){
		...
		$.ajax({
	 		...
	 		data:paramData,
	 		url:"<%=request.getContextPath()%>/certificate/insertCertificate.action",
...
function param(){
	var o = {};
	o.receiveUserIds = receiveUserId;
	o.name=$("#name").val();
...
<div class="content">
	...
	<div style="padding-bottom: 5px;border-bottom: 1px solid #cccccc; margin-bottom: 10px;">
		...
		<span style="  position: relative;top: 5px; color: #3a3a3a; font-size: 16px; font-weight: bold;">新增证书</span>
	 </div>
	<form id="addForm">
	<div class="lesson_add">
    	...
    	<div class="add_gr">
            ...
            <div class="add_fr">
            	<input type="text" style="width:319px;" id="receiveUserName" name="receiveUserName" disabled/>
    	...
    	<div class="add_gr">
        	<div class="add_fl">
             ...
             <div class="add_fr">
            	<select id="trainAgencyLevel" name="trainAgencyLevel">
