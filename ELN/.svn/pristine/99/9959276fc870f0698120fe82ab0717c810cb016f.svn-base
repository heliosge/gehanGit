...
<style>
	...
	.ztree li span.button.noline_open{margin-left:10px;position: absolute;background:url("");}
	.ztree li span.button.noline_close{margin-left:10px;position: absolute;background:url("");}
	...
	.page_div_1 {width: 250px;height: auto;border: 1px solid #333;float: left;font-family: '微软雅黑';}
	.page_div_1 h2 {font-size: 14px;background: #333;color: white;text-align: center;height: 30px;line-height: 30px;font-weight: normal;}
...
function choosePage(){
	$.fn.zTree.init($("#chooseTreePage"), notCheckSetting, pageList);
	var chooseTreeObj = $.fn.zTree.getZTreeObj("chooseTreePage");
