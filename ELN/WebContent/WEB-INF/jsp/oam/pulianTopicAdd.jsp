...
.ztree li span.button.noline_open{margin-left:13px;position: absolute;background:url("");}
.ztree li span.button.noline_close{margin-left:13px;position: absolute;background:url("");}
	...
	$('#addForm').isValid(function(v) {
		if(v){
			...
			$.ajax({
				...
				data:param,
				url:"<%=request.getContextPath()%>/oam/insertOamTopic.action",
				success:function(data){
					if(data == 'SUCCESS'){
...
<div class="content">
	...
	<div style="padding-bottom: 5px;border-bottom: 1px solid #cccccc; margin-bottom: 10px;">
		...
		<span style="  position: relative;top: 5px; color: #3a3a3a; font-size: 16px; font-weight: bold;">新增专题</span>
	 </div>
	<form id="addForm">
