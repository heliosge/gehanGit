...
function loadMMGrid(){
	...
	$('#examTable').mmGrid({
		...
		url:'<%=request.getContextPath()%>/exam/exam/getSimVoList.action',
		width: '1065px',
		height: 'auto',
	    ...
	    params:function(){
	    	...
	    	param.createTimeBegin = $("#createTimeBegin").val();
	    ...
	    cols: [{title: 'ID', name: 'id', hidden:true},
	           {title:'考试名称', name:'title', width:150,align:'center', 
              	...
              	{title:'试卷总分',name:'totalScore', width:40,align:'center'},
              	{title:'考试时长',name:'duration', width:40,align:'center'},
              ...
              {title:'考试状态',name:'examStatus', width:40,align:'center',
               ...
               {title:'操作',name:'operation', width:100,align:'center',
                	renderer:function(val,item, rowIndex){
	               		...
	               		var str_publish = '<a href="javascript:void(0);" onclick="publishExam('+ item.id +')" >发布</a>&nbsp;';
...
<div class="content">
    ...
    <div class="lesson_tab_1">
        	<ul>
            	<li id="type1" onclick="setExamList(1);">正式考试</li>
                <li class="li_this" id="type3">模拟考试</li>
            </ul>
	</div>
    <div class="content_2">
        <div class="btn_gr fl">
        ...
        <div class="search_2 fl">
            <p>考试名称：<input type="text" id="title" name="title"/>
	                考试开始时间：<input type="text" id="createTimeBegin" name="createTimeBegin" readonly="readonly"/>
	                <span>至</span>
	                <input type="text" id="createTimeEnd" name="createTimeEnd" readonly="readonly"/>
	                考试状态：
