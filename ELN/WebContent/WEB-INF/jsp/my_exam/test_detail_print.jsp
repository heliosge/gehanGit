...
$(function(){
	...
	//调整iframe高度
	//alert($("html").height());
	parent.$("#paperIframe_"+exam_assign_id).height($("html").height()+500);
	parent.myPrintNum.load ++;
});
...
<body>
	<div class="on_test" style="margin-top:5px;width:100%;">
    	<div class="test_title" style="width:100%;">
        	<h3 id="title" style="font-size:16px;" ></h3>
        </div>
        <div class="test_tool" style="width:100%;">
        	<div class="tool_top">
            	<p>考试详情：
            ...
            <div class="tool_bottom" id="inputDiv" style="display:none;">
