...
<div id='content_i' class='content' >
	<div class='knowledge'>
		...
		<div style="padding-bottom: 5px;border-bottom: 1px solid #cccccc; margin-bottom: 10px;">
			...
			<span style="  position: relative;top: 5px; color: #3a3a3a; font-size: 16px; font-weight: bold;">修改资讯</span>
		</div>
	</div>
	<div class="lesson_add">
	<form action="" id="addForm">
		<input type="hidden" id='infoId' name="infoId" value="${informationBean.infoId}">
    	<div class="add_gr">
        	<div class="add_fl">
            	<span>*</span>
                <em>标题：</em>
            ...
            <div class="add_fr">
            	<input type="text" style="width:270px;" id="infoName" name="infoName" value="${informationBean.infoName}">
            </div>
        </div>
        <div class="add_gr" style='height:430px'>
            ...
            <div class="add_fr">
				<textarea rows="10" cols="110" name="content">${informationBean.infoContent}</textarea>
            </div>
        </div>
        <div class="add_gr">
        	<div class="add_fl">
             ...
             <div class="add_fr">
            	...
            	<script type='text/javascript'>
            		if(${informationBean.isBanner}==1){
            			$("input[name='isBanner']").eq(0).attr("checked",true);
            		}else{
            			$("input[name='isBanner']").eq(1).attr("checked",true);
            		}
            	</script>
            </div>
    	</div>
        <div class="add_gr">
            ...
            <div class="add_fr" style="margin-top: 7px;">
				...
				<input type="hidden" id="bannerFilePath" name="bannerFilePath" value="${informationBean.bannerFilePath}"/>
				<input type="hidden" id='bannerFileName' name='bannerFileName' value="${informationBean.bannerFileName}">
            </div>
        </div>
         <div class="add_gr">
            ...
            <div class="add_fr" style="margin-top: 7px;">
           		<div class="previewPic">
           			...
           			<script type='text/javascript'>
						...
						//预览图片
						$("#bannerPath").attr("src","${informationBean.bannerFilePath}").css({"width":"700px","height":"300px"});;
...
<script  type='text/javascript'>
	function saveInformation(){
		...
		param.infoId=$("input[name='infoId']").val();//knowledge_name
		...
		$.ajax({
    		...
    		data:param,
    		url:"<%=request.getContextPath()%>/information/update.action",
