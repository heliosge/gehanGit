			...
			$.ajax({
				...
				success:function(data){
					if(data == 'SUCCESS'){
						...
						//+"&courseId="+courseId+"&sectionCount="+sectionCount;
					}else{
						dialog.alert("操作失败。");
					}
...
function prev(){
	window.location.href="<%=request.getContextPath()%>/mall/manage/toCourseEditPage.action?id="+mallCourseId;
}
...
<div class="content">
	...
	<div style="padding-bottom: 5px;border-bottom: 1px solid #cccccc; margin-bottom: 10px;">
		...
		<span style="  position: relative;top: 5px; color: #3a3a3a; font-size: 16px; font-weight: bold;">课程章节</span>
	</div>
    <form id="addForm">
    <div class="capter">
    	<div class="ca_top">
