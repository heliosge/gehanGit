...
function getQuestions(){
	$.ajax({
		...
		url: "<%=request.getContextPath()%>/train/getQuestions.action",
...
<div class="content" style="padding-bottom: 0px;">
    ...
    <div class="" style="padding-top: 15px;">
          <input type="button" value="提交" class="buttonClass" style="background-color: #0c9c92" onclick="submitQuestionnaire()" />
