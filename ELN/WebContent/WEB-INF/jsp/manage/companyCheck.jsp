...
<div class="content">
	...
	<div style="padding-bottom: 5px;border-bottom: 1px solid #cccccc; margin-bottom: 10px;">
		...
		<span style="  position: relative;top: 5px; color: #3a3a3a; font-size: 16px; font-weight: bold;">审批企业</span>
	</div>
	<div class="lesson_add_2">
        ...
        <div class="button_cz">
        	<input type="button" value="通过" class="back" onclick="check()"/>
            <input type="button" value="不通过" class="back" onclick="unCheck()"/>
        </div>
      </div>
   </div>
</body>
