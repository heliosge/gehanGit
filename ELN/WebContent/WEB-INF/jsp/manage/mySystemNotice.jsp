...
$(function(){
	...
	$('#exampleTable').mmGrid({
		...
		url:"<%=request.getContextPath()%>/manageUser/selectMySystemNoticeList.action",
        ...
        params: function(){
     	...
     	cols: [{title: 'ID', name: 'id', width:30, hidden:true},
              /*  {title: '序号', name: 'id', width:60, align:'center'}, */
...
<div id="content_i">
	<div class="left_nav">
        ...
        <ul  id="left_nav">
            ...
            <li   class="active_2"><a href="#" class="active_3">站内信-系统消息</a></li>
