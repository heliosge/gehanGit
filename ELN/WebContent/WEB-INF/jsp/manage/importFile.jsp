...
$(function(){
	...
	var uploader = WebUploader.create({
	    ...
	    // 文件接收服务端。
	    server:'<%=request.getContextPath()%>/manageCompany/importXlsFileData.action',
...
<div  class='dialog-content'>	
    	...
    	<div class='tit-err' style='height:70px;width:100%;overflow-y:auto;float:left;'>
    	 ...
    	 <div class="button_cz" style='padding: 0px;margin-left: 227px;'>
            ...
            <input type="button" value="返回" class="back" onclick='javascript:parent.location = "<%=request.getContextPath()%>/manageCompany/toCompanyListPage.action"'>
        </div>
</div>	
