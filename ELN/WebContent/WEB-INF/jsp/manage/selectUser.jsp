...
$(function(){
	...
	$('#exampleTable').mmGrid({
        ...
        cols: [{title: 'ID', name: 'id', width:60, hidden:true},
			   ...
			   /* {title: '职位', name: 'position', width:60},
			   ...
			   {title: '性别', name: 'gender', width:60, renderer:function(val, item, rowIndex){
				   if(val == 0){
					   return "男";
				   }else if(val == 1){
					   return "女";
			   ...
			   /* {title: '移动电话', name: 'phone', width:100, hidden:true},
			   {title: '邮箱', name: 'email', width:150, hidden:true},
