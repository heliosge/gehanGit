...
function save(){
	...
	$.ajax({
 		...
 		data:param,
 		url:"<%=request.getContextPath()%>/manageUser/uploadPhoto_.action",
 		success:function(data){
 			if(data == 'SUCCESS'){
 				dialog.alert("照片上传成功！",function(){
	    ...
	    <div class="add_gr">
        	<div class="add_fl">
             ...
             <div class="add_fr" >
				...
				<img id="previewPath" src="${photo }" style="margin-top:10px;" width="100px" height="80px"/>
            </div>
