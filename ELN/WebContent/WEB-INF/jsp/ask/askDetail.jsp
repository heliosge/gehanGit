...
#chosePlanformResourceButton {
	width: 120px;
	height: 33px;
	border: medium none;
	margin-top: 6px;
	cursor: pointer;
	background: #D60500 none repeat scroll 0% 0%;
	color: #FFF;
}

#uploadLocalFileButton {
	width: 120px;
	height: 33px;
	border: medium none;
	margin-top: 6px;
...
.kl-item { /* font-family: 微软雅黑;margin-bottom: 5px; */
